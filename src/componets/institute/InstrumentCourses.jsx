    ...
    <div className="bg-[#F0E81B]  min-h-screen py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-black mb-4">
            Instrument Courses
          </h1>
        </div>
          ...
          {instruments.map((instrument) => (
            <div key={instrument.id} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-4 sm:p-5 lg:p-4 xl:p-6">
                {/* Instrument Name */}
                <h3 className="text-lg sm:text-xl lg:text-lg font-['Playfair Display'] xl:text-xl font-bold text-black mb-3 sm:mb-4">
                  {instrument.name}
                </h3>

                {/* Description */}
                <p className="text-gray-700 text-sm sm:text-base lg:text-sm font-['Roboto'] xl:text-base leading-relaxed mb-4 sm:mb-6">
